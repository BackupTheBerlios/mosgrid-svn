...
--
-- Table structure for table `stat_AggregateJob`
--

DROP TABLE IF EXISTS `stat_AggregateJob`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `stat_AggregateJob` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `Resource` varchar(255) DEFAULT NULL,
  `NumberOfJobs` int(11) DEFAULT NULL,
  ...
  `squaresOfRunningTime` int(11) DEFAULT NULL,
