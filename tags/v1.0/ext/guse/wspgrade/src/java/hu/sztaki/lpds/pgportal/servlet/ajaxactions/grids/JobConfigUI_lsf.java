...
public class JobConfigUI_lsf implements JobConfigUI {
    ...
    public Hashtable getJobParameters(String user, HashMap exeParams,List<Middleware> sessionConfig) {
        Hashtable conf = new Hashtable(new JobConfigUtils().getResourcesForSsh(user, "lsf", exeParams, sessionConfig));
