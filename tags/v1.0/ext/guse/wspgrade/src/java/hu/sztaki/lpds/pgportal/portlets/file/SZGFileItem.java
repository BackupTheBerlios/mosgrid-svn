 ...
 *
 */
// SZGFileItem.java v1.0
// Birsen Omay

// File structure for the file browser

package hu.sztaki.lpds.pgportal.portlets.file;

import java.util.ArrayList;

public class SZGFileItem extends SZGItem{

	public SZGFileItem(String name, String pathName, SZGItem parent){
