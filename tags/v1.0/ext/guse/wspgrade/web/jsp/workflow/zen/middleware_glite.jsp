<%-- 
glite,local,finish,random middleware job
--%>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
<%@ taglib uri="/lpdsmessage" prefix="msg"%>

<script src="${pageContext.request.contextPath}/js/jquery/jquery.bt.min.js" type="text/javascript" charset="utf-8"></script>
