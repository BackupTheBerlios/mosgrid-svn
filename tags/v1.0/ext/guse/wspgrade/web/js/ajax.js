...
function setHelpText()
{
        ...
        if((request.readyState == 4)&&(request.status == 200))
	{
            ...
            if (resp != null)
	    {
		document.getElementById('helptext').innerHTML="<div style=\"margin-top:140px;\"><div style=\"float:right;\"><a href=\"#\" onclick=\"viewToolTip('helptext','')\"><img src=\""+webapp+"/img/close.gif\" /></a></div><br/>"+resp+"</div>";
            }
        } 
//	else {alert("A problem occurred with communicating between the XMLHttpRequest object and the server program.");}
    } 
...
//    if ((navigator.userAgent.indexOf("Mozilla")>=0)||(navigator.userAgent.indexOf("Opera")>=0))
	...
	return objXmlHttp
		...
		function openClosePanel(pDiv,pImg)
		{
			...
			document.getElementById(pImg).src=webapp+"/imgs/window/maximize.png";
		    }
		    else 
		    {
			x.style.display="block";
			document.getElementById(pImg).src=webapp+"/imgs/window/minimize.png";
		    }
		}
