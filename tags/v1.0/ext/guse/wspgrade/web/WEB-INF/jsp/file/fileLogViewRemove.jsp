...
<table>
	<tr bgcolor=#ffffff><td>
		...
		<tr bgcolor="#ffffff">
			...
			<lpds:submit  actionID="action" actionValue="doGoBack" paramID="itemName" paramValue='<%=fileName%>' paramID="fromPage" paramValue="logviewremove" cssClass="portlet-form-button" txt="Back" tkey="false" />
