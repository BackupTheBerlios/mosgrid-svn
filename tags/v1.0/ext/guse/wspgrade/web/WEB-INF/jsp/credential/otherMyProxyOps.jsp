...
<form method="post" action="${pURL}">
    ...
    <table width="100%" cellpadding="5" >
        ...
        <tr><td><lpds:submit actionID="guse" actionValue="doInformation" cssClass="portlet-form-button" txt="Information" tkey="true" /></td></tr>
        ...
        <tr><td colspan="4"><br></td></tr>
        <tr><td><lpds:submit actionID="guse" actionValue="doChangePass" cssClass="portlet-form-button" txt="Change password" tkey="true" /></td></tr>
        ...
        <tr><td colspan="4"><br></td></tr>
        <tr><td><lpds:submit actionID="guse" actionValue="doDestroy" cssClass="portlet-form-button" txt="Destroy" tkey="true" /></td></tr>

    </table>
    <div align="center"><lpds:submit actionID="guse" actionValue="doGoCredentialList" cssClass="portlet-form-button" txt="Back" tkey="true" /></div>
