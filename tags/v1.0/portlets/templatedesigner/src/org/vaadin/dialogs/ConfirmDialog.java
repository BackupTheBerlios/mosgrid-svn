...
public class ConfirmDialog extends Window {
	 ...
	 * @return
	 */
	public static ConfirmDialog show(final Window parentWindow, final String windowCaption, final String message,
			final String okCaption, final String cancelCaption, final Listener listener) {
	...
	public static ConfirmDialog show(final Window parentWindow, final String windowCaption, final String message,
		...
		d.show(parentWindow, new Listener() {
			...
			private static final long serialVersionUID = -4916196822255455185L;
	...
	public final void setContentMode(final int contentMode) {
		...
		messageLabel.setValue(contentMode == CONTENT_TEXT_WITH_NEWLINES ? formatDialogMessage(originalMessageText)
				: originalMessageText);
	}
