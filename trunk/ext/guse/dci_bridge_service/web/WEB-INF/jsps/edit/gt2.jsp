...
<table>
    <tr>
        <td><%-- grid data--%>
            <table class="editdata" >
                ...
                <tr>
                    ...
                    <td><input type="text" name="pgt2name" size="25" value="${item.name}"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="paccessdata" size="60" value="${item.gt2.accessdata}" /></td>
                </tr>
                <tr>
                    <th><f:message key="new.gt2.type" /></th>
                    <td><input type="text" name="ptype" size="60" value="${item.gt2.type}" /></td>
                </tr>
                <tr>
        ...
        <td><%-- new site and jobmanaver--%>
            <table class="newdata" >
                <caption><f:message key="caption.gt2.resources.new" /></caption>
