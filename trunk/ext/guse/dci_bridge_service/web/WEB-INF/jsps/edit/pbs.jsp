...
<tr><td>
<table class="newdata" >
    <caption><f:message key="caption.edit.pbs" /></caption>
    <tr>
        <th class="ln0"><f:message key="new.pbs.name" /></th>
        <td class="ln0"><input type="text" name="ppbsname" value="${item.name}" size="20"/></td>
    </tr>
    <tr>
    ...
    <tr>
        <th colspan="2" class="ln1"><center><f:message key="delete.cluster.queue" /><center></th>
    </tr>
