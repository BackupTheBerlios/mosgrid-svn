...
<table class="newdata" >
    <caption><f:message key="caption.gt2.new" /></caption>
    <form method="post" action="conf">
    <tr>
        <th class="ln0"><f:message key="new.gt2.name" /></th>
        <td class="ln0"><input class="ln0" type="text" name="pgt2name" size="25" /></td>
    </tr>
    <tr>
    ...
    <tr>
        <th class="ln0"><f:message key="new.gt2.accessdata" /></th>
        <td class="ln0"><input class="ln1" type="text" name="paccessdata" size="60" /></td>
    </tr>
    <tr>
        <th class="ln1"><f:message key="new.gt2.type" /></th>
    ...
    <tr>
        <th class="${css}"><f:message key="new.gt2.site"  /></th>
    ...
    <tr>
        <td colspan="2"><input type="image" src="imgs/save.png" value="<f:message key="form.ok" />" /></td>
    </tr>
</form>
</table>
</f:bundle>