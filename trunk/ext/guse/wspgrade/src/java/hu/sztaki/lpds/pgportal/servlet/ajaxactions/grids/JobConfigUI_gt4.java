...
public class JobConfigUI_gt4 implements JobConfigUI {
    ...
    public Hashtable getJobParameters(String user, HashMap exeParams,List<Middleware> sessionConfig) {
        Hashtable conf = new Hashtable(new JobConfigUtils().getGridResourceJobmngrParams("gt4", exeParams, sessionConfig));
