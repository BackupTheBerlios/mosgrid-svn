...
<table class="newdata">
    <caption><f:message key="caption.edgi.new" /></caption>
    <form method="post" action="conf">
    <tr>
        <th class="ln0"><f:message key="new.edgi.name" /></th>
        <td class="ln0"><input class="ln0" type="text" name="pedginame" size="25" /></td>
    </tr>
    <tr>
    ...
    <tr>
        <th class="ln1"><f:message key="new.edgi.url" /></th>
        <td class="ln1"><input class="ln0" type="text" name="pedgiurl" size="60" value="http://" /></td>
    </tr>
    <tr>
