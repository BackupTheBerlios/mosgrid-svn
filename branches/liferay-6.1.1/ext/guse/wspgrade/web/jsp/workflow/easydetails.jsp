...
<msg:help id="helptext" tkey="help.easydetails" img="${pageContext.request.contextPath}/img/help.gif" />

<portlet:defineObjects/>
<portlet:actionURL var="pURL" action="doWkfvisualizer" portletMode="VIEW" />
    <table width="100%">
        <tr>
	    <td colspan="8">
		<form method="post" action="${pURL}"> 
		    ...
		    <lpds:submit actionID="action" actionValue="doWkfvisualizer" paramID="workflow" paramValue="${wrkdata.workflowID}" cssClass="portlet-form-button" txt="button.visualize" tkey="true"/>		
		</form>
	    </td>
	</tr>
        <tr>
