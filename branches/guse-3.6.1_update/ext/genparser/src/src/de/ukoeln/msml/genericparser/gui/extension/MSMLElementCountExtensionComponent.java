...
public class MSMLElementCountExtensionComponent extends JPanel implements
		IMSMLParserComponent {
	
	private static final long serialVersionUID = 1L;
	private JTextField txtCountPattern;
	private MSMLElementCountExtension _ext;
	
	public MSMLElementCountExtensionComponent(MSMLElementCountExtension ext) {
		this();
		_ext = ext;
	}
	
	public MSMLElementCountExtensionComponent() {
		...
		JLabel lblCountPattern = new JLabel("Array-Delimiter:");
