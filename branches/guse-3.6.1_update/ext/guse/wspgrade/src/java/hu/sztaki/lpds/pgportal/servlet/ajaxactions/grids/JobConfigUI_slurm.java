...
public class JobConfigUI_slurm implements JobConfigUI {

    public String getJsp() {
        return "/jsp/workflow/zen/middleware_ssh.jsp";
    }

    public Hashtable getJobParameters(String user, HashMap exeParams,List<Middleware> sessionConfig) {
        Hashtable conf = new Hashtable(new JobConfigUtils().getResourcesForSsh(user, "slurm", exeParams, sessionConfig));
