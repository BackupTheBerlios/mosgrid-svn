...
public class JobConfigUI_pbs implements JobConfigUI {
    ...
    public Hashtable getJobParameters(String user, HashMap exeParams,List<Middleware> sessionConfig) {
        Hashtable conf = new Hashtable(new JobConfigUtils().getResourcesForSsh(user, "pbs", exeParams, sessionConfig));
