...
/*
  * TimeoutExecutorExtension.java
  *
  * Created on January 30, 2005, 12:26 PM
  */
...
/**
  ...
  * @author  boci
  */
public class TimeoutExecutorExtension extends TimeoutExecutor{

    private Object result;
    private TimeoutThread timeoutT = null;
    private FunctionThread funcT = null;
    
    /** Creates a new instance of TimeoutExecutorExtension */
    public TimeoutExecutorExtension() {
        this.result = null;
    }
  ...
  private void stopExecution() {
    this.timeoutT = null;
    this.interruptFunctionAtTimeout();
    this.funcT = null;
  }

  private void interruptFunctionAtTimeout(){
      if (this.result.equals(TimeoutExecutor.RESULT_AT_TIMEOUT)) {
          try {
            this.funcT.interrupt();
          }
   ...
   * @param iisFunctionInterrupted When timeout is occured the function thread is interrupt or not
