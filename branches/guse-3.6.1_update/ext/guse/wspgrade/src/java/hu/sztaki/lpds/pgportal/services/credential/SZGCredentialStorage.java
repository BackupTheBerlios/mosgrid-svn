...
interface SZGCredentialStorage {

	/**
	 * Stores credential using the key.
	 * 
	 * @param credential
	 * @param key
	 */
	public void put(SZGCredential credential, SZGStoreKey key)
			throws SZGCredentialException;

	/**
	 * Gets credentials belonging to the given userKey.
	 * 
	 * @param key
	 * @return credential
	 */
	 ...
	 * @return credential
	 */
	public SZGCredential get(SZGStoreKey key) throws SZGCredentialException;
	 ...
	 * @param key
	 */
	public void remove(SZGStoreKey key) throws SZGCredentialException;
	 ...
	 * @param key
	 */
	public void removeCredentials(String userId) throws SZGCredentialException;

	public void setUseThis(SZGStoreKey key);

	public SZGCredential getUseThis(String userId);

	public void setCredentialForGrid(String userId, String certId,
			String gridName);
