...
<table class="portlet-frame">
   ...
   <tr>
         ...
         <td>
           ...
           <td>Description</td>
           <td>
              <textarea  class="portlet-msg-info"name="desc"></textarea>
           </td>
    </tr>
    <tr bgcolor="#ffffff">
    ...
    <tr bgcolor="#ffffff"><td colspan=4 align=center>
     <lpds:submit actionID="guse" actionValue="doDownload" cssClass="portlet-form-button" txt="Download" tkey="true" />
