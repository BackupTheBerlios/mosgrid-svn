...
<div id="plugin" style="display:block">
    ...
    <!--
    <tr>
        <td width="30%"><msg:getText key="text.plugin.wfmultipl" />: </td>
        <td>           
    ...
    <tr>
        <td width="30%"><msg:getText key="text.day.default" />: </td>
        <td>           
...
<c:forEach var="day" items="${days}">
 ...
 <!--   <input type="button" class="portlet-form-button" onclick="javascript:setRemoteParamDOMValue('wfp_wfmultipl,wfp_startDate,wfp_endDate,wfp_defstarth,wfp_defstartm${save}');document.getElementById('cdata').style.display='none'" value="Save">    -->
     <input type="button" class="portlet-form-button" onclick="javascript:setRemoteParamDOMValue('wfp_project');closediv('cdata');" value="Save">    
