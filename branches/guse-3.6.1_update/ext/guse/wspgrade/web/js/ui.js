...
//	Div(100,100,10,10,0,"#ffccdd",pDiv);
	...
	document.getElementById(pDiv).innerHTML="<div style=\"float:right\"><a href=\"#\" title=\"close\" onclick=\"viewToolTip('"+pDiv+"','')\"><img src=\""+webapp+"/img/close.gif\" /></a></div><br/>"+pText;
    }
    else
    { 
	...
	{
	Div(0,0,tempY,tempX+10,0,"#90CCFD",pDiv);
	document.getElementById(pDiv).innerHTML="<div style=\"float:right\"><a href=\"#\" onclick=\"viewToolTip('"+pDiv+"','')\"><img src=\""+webapp+"/img/close.gif\" /></a></div><br/>"+pText;
	}
...
//	document.getElementById('div_wait').style.display='block';
	setRemoteParamDOMValue('job_gridtype,job_grid,job_resource,job_jobmanager,job_params');
	getConfForm('m=GetJobView&job='+jID);
    }
}
