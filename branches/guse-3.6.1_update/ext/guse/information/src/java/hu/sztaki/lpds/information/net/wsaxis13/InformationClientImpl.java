...
/**
 * Sets the URL of the service needed to be accessed
 * @param value Access point of the used service
 */
    public void setServiceURL(String value){serviceURL=value;}    
    
/**
 * Sets the ID of the service needed to be accessed
 * @param value ID of the used service
 */
 ...
 * @param pFrom source of the search
 ...
 */
    public ServiceType getService(String pStype, String pFrom, Hashtable pParam, Vector pFault) throws Exception
    {
      ...
      return (ServiceType)call.invoke( new Object[] {pStype,pFrom,pParam,pFault} );
    }
