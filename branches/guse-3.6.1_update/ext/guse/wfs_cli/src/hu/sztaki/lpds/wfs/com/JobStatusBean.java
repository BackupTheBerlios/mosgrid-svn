 ...
 */
    ...
    {
//        System.out.println(pJobID+":"+pPID+":"+pStatus);
        setJobID(pJobID);
        setStatus(pStatus);
        setResource(pResource);
        setTim(pTim);
  ...
  * @see String
  */   
    public String getPortalID(){return (String)data.get("portalID");}
  ...
  * @see String
  */   
    public long getTim(){return (data.get("tim")==null)?0:((Long)data.get("tim")).longValue();}
    
 /**
  * Status valtozas idobelyeg lekerdezese
  * @return idobelyeg
  */   
    public String getWorkflowStatus(){return (String)data.get("workflowStatus");}
  ...
  * @see String
  */   
    public String getWrtID(){return (String)data.get("wrtID");}
  ...
  * @see String
  */
    public long getPID(){return (data.get("pID")==null)?0:((Long)data.get("pID")).longValue();}
  ...
  * @see long
  */
    public long getWorkflowSubmitID(){return (data.get("submitID")==null)?0:((Long)data.get("submitID")).longValue();}
  ...
  * @see String
  */   
    public String getUserID(){return (String)data.get("userID");}
  ...
  * @see String
  */   
    public String getWorkflowID(){return (String)data.get("workflowID");}
  ...
  * @see String
  */   
    public String getJobID(){return (String)data.get("jobID");}
  ...
  * @see String
  */   
    public String getResource(){return (String)data.get("resource");}
 ...
 */    
    public void setStatus(int value){data.put("status", value);}
 ...
 * @see String
 */    
    public void setResource(String value){data.put("resource", value);}
    
/**
 * Status valtozas idobelyeg beallitasa
 * @param value idobelyeg
 */    
    public void setTim(long value){data.put("tim", value);}
/**
 * Workflow Status beallitasa
 * @param value Status
 * @see String
 */    
    public void setWorkflowStatus(String value){data.put("workflowStatus", value);}
 ...
 * @see String
 */    
    public void setWrtID(String value){data.put("wrtID", value);}
    
/**
 * Job parametrikus ID beallitasa
 * @param value PID
 */    
    public void setPID(long value){data.put("pID", new Long(value));}

/**
 * Workflow Submit ID beallitasa
 * @param value PID
 */
    public void setWorkflowSubmitID(long value){data.put("submitID", new Long(value));}
 ...
 */    
    public void addOutputCount(String pOutput, int pCount){outputs.put(pOutput, new Integer(pCount));}
 ...
 */    
    public int getOutputCount(String pOutput){return ((Integer)outputs.get(pOutput)).intValue();}
    
/**
 * Outputs setter
 * @param pData outputok es szamossaguk
 */    
    public void setOutputs(Hashtable pData){outputs=pData;}
/**
 * Outputs getter
