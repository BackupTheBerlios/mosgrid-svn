 ...
 * @return logikai ertek
 */
    public static boolean isFinished(int pStatus) {return pStatus==FINISH;}
/**
 * Statusz vizsgalat Hibas futasra
 * @param pStatus vizsgalando status kod
 * @return logikai ertek
 */
    public static boolean isError(int pStatus) {return pStatus==ERROR;}
/**
 * Statusz vizsgalat Job nem tuttathato allapotra
 * @param pStatus vizsgalando status kod
 * @return logikai ertek
 */
    public static boolean isNotRunnable(int pStatus) {return pStatus==NOTRUNNABLE;}
/**
 * Statusz vizsgalat megszakitasi allpotra
 * @param pStatus vizsgalando status kod
 * @return logikai ertek
 */
    public static boolean isAbort(int pStatus) {return pStatus==ABORTED || pStatus==ABORTING;}
/**
 * Statusz vizsgalat megszakitasra
 * @param pStatus vizsgalando status kod
 * @return logikai ertek
 */
    public static boolean isAborted(int pStatus) {return pStatus==ABORTED;}
/**
 * Statusz vizsgalat folyamatban levo megszakitasra
 * @param pStatus vizsgalando status kod
 * @return logikai ertek
 */
    public static boolean isAborting(int pStatus) {return pStatus==ABORTING;}
/**
 * Statusz vizsgalat Initalasra
 * @param pStatus vizsgalando status kod
 * @return logikai ertek
 */
    public static boolean isInit(int pStatus) {return pStatus==INIT;}
/**
 * Statusz vizsgalat be nem fejezett futasra
 * @param pStatus vizsgalando status kod
 * @return logikai ertek
 */
    public static boolean isNotEndAndNotInit(int pStatus){return !isEndStatus(pStatus) && pStatus!=INIT;}
