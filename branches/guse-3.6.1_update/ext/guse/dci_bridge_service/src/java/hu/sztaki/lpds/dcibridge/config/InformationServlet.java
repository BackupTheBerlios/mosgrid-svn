...
/*
 * Event handler for visualization of coonfiguration information 
 */
...
/* store actual submenu item*/
        if(request.getParameter("t")!=null){
            ...
            String selectedC=request.getParameter("t");
            request.setAttribute("item",Conf.getItem(selectedMMI, selectedC));
        }
        request.setAttribute("conf", Conf.getM());
        getServletContext().getRequestDispatcher("/WEB-INF/jsps/information/index.jsp").include(request, response);
    } 
