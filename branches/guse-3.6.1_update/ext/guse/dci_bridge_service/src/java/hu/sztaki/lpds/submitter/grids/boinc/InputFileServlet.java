...
public class InputFileServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        String[] partURL=request.getPathInfo().split("/");
        String fileName=partURL[partURL.length-1];
        String jobID=partURL[partURL.length-2];
        String path=Base.getI().getPath()+jobID+"/"+fileName;
