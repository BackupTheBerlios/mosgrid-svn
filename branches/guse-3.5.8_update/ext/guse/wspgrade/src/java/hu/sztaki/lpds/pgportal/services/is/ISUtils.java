...
package hu.sztaki.lpds.pgportal.services.is;
...
public class ISUtils {
    ...
    /** Creates a new instance of ISUtils */
    public ISUtils() {
    }
    
    public static boolean isBaseDnValid(String baseDn){
        if ( baseDn == null ) return false;
        
        Pattern pattern = Pattern.compile("^(mds\\-vo\\-name\\=[a-zA-Z\\-\\_]+\\,o\\=grid)$");
