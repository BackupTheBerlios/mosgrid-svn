...
public class ASMJob {
	 ...
	 *            - name of the job
	 * @param inputports
	 *            - Hashtable that contains inputports (key: portNumber E (0..15); value: name of the port )
	 * @param outputports
	 *            - Hashtable that contains outputports (key: portNumber E (0..15); value: name of the port )
	 */
